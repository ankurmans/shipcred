...
const TIER_1_ITEMS = [
  {
    ...
    max: 350,
    description: 'We scan your commits for AI tool signatures across 18 tools. Volume follows a logarithmic curve (diminishing returns past ~100 commits), plus bonuses for repo diversity, tool variety, recency, and velocity.',
    details: [
      'Detected tools: Claude Code, Copilot, Cursor, Aider, Windsurf, Devin, Lovable, Bolt.new, Replit Agent, v0.dev, Base44, OpenAI Codex, Google Jules, Gemini Code Assist, Cody, Pythagora, Same.dev, Firebase Studio',
      ...
      'Tool diversity: using multiple AI tools scores higher than one tool',
